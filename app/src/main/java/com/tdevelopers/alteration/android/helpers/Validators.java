package com.tdevelopers.alteration.android.helpers;
...
public class Validators {
    ...
    public static class DateValidator extends METValidator {
        ...
        public boolean isValid(@NonNull CharSequence text, boolean isEmpty) {
            return !com.tdevelopers.alteration.android.helpers.CardValidator.isDateExpired(text.toString());
        }
    }
    ...
    public static class CardValidator extends METValidator {
        ...
        public boolean isValid(@NonNull CharSequence text, boolean isEmpty) {
            ...
            int result;
            if (com.tdevelopers.alteration.android.helpers.CardValidator.masterCardWithoutLength(card)
                    || com.tdevelopers.alteration.android.helpers.CardValidator.dinnersClubIntWithoutLength(card)
                    || com.tdevelopers.alteration.android.helpers.CardValidator.visaCardWithoutLength(card)
                    || com.tdevelopers.alteration.android.helpers.CardValidator.amexCardWithoutLength(card)
                    || com.tdevelopers.alteration.android.helpers.CardValidator.discoverCardWithoutLength(card)) {
                result = com.tdevelopers.alteration.android.helpers.CardValidator.isValid(card, false);
            } else {
                result = com.tdevelopers.alteration.android.helpers.CardValidator.isValid(card, true);
            }
            return result != 0;
        }
    }
