 ...
 * Implements Calligraphy using reflection. The default fontstyle will be applied through context wrappers
 * as defined in the Calligraphy Documentation. Any newly created activity must extend this BaseActivity
 * for the proper application of the default fontstyle.
 */
